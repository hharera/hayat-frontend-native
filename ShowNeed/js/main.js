...
getNeeds('http://146.190.206.136:8082/api/v1/needs/results?page=1');
...
page2.addEventListener('click',function(){
  ...
  getNeeds('http://146.190.206.136:8082/api/v1/needs/results?page=2');
})
page3.addEventListener('click',function(){
  ...
  getNeeds('http://146.190.206.136:8082/api/v1/needs/results?page=3');
})
page4.addEventListener('click',function(){
  ...
  getNeeds('http://146.190.206.136:8082/api/v1/needs/results?page=4');
})
...
let li=document.querySelectorAll('.needs1 .categories ul li');
let all=document.querySelector('.needs1 .categories ul .all');
let blood=document.querySelector('.needs1 .categories ul .blood');
let books=document.querySelector('.needs1 .categories ul .books');
let medicine=document.querySelector('.needs1 .categories ul .medicine');
...
blood.addEventListener('click',function(){
  ...
  blood.classList.remove('notclicked');
  blood.classList.add('clicked');
  getNeeds('http://146.190.206.136:8082/api/v1/needs/blood/results?');
})
books.addEventListener('click',function(){
  ...
  getNeeds('http://146.190.206.136:8082/api/v1/needs/book/results?');
})
...
medicine.addEventListener('click',function(){
  ...
  getNeeds('http://146.190.206.136:8082/api/v1/needs/medicine/results?');
})
