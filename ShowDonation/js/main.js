...
getDonations('http://146.190.206.136:8084/api/v1/donations/results?page=1');
...
page2.addEventListener('click',function(){
  ...
  getDonations('http://146.190.206.136:8084/api/v1/donations/results?page=2');
})
page3.addEventListener('click',function(){
  ...
  getDonations('http://146.190.206.136:8084/api/v1/donations/results?page=3');
})
page4.addEventListener('click',function(){
  ...
  getDonations('http://146.190.206.136:8084/api/v1/donations/results?page=4');
})
...
let li=document.querySelectorAll('.donations1 .categories ul li');
let all=document.querySelector('.donations1 .categories ul .all');
let foods=document.querySelector('.donations1 .categories ul .foods');
let books=document.querySelector('.donations1 .categories ul .books');
let medicine=document.querySelector('.donations1 .categories ul .medicine');
let clothes=document.querySelector('.donations1 .categories ul .clothes');

all.addEventListener('click',function(){
  for(let i=0;i<li.length;i++){
    li[i].classList.add('notclicked');
  }
  all.classList.remove('notclicked');
...
foods.addEventListener('click',function(){
  ...
  foods.classList.remove('notclicked');
  foods.classList.add('clicked');
  getDonations('http://146.190.206.136:8084/api/v1/donations/food/results?');
})
books.addEventListener('click',function(){
  for(let i=0;i<li.length;i++){
    li[i].classList.add('notclicked');
  }
  books.classList.remove('notclicked');
  books.classList.add('clicked');
  getDonations('http://146.190.206.136:8084/api/v1/donations/book/results?');
})
...
medicine.addEventListener('click',function(){
  ...
  medicine.classList.remove('notclicked');
  medicine.classList.add('clicked');
  getDonations('http://146.190.206.136:8084/api/v1/donations/medicine/results?');
})
...
clothes.addEventListener('click',function(){
  ...
  clothes.classList.remove('notclicked');
  clothes.classList.add('clicked');
  getDonations('http://146.190.206.136:8084/api/v1/donations/clothing/results?');
})
