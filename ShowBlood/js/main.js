...
getNeeds('http://146.190.206.136:8082/api/v1/needs/blood/results?page=1');
...
page2.addEventListener('click',function(){
  ...
  getNeeds('http://146.190.206.136:8082/api/v1/needs/blood/results?page=2');
})
page3.addEventListener('click',function(){
  ...
  getNeeds('http://146.190.206.136:8082/api/v1/needs/blood/results?page=3');
})
page4.addEventListener('click',function(){
  ...
  getNeeds('http://146.190.206.136:8082/api/v1/needs/blood/results?page=4');
})
