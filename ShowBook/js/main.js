...
getDonations('http://146.190.206.136:8084/api/v1/donations/book/results?page=1');
...
page2.addEventListener('click',function(){
  ...
  getDonations('http://146.190.206.136:8084/api/v1/donations/book/results?page=2');
})
page3.addEventListener('click',function(){
  ...
  getDonations('http://146.190.206.136:8084/api/v1/donations/book/results?page=3');
})
page4.addEventListener('click',function(){
  ...
  getDonations('http://146.190.206.136:8084/api/v1/donations/book/results?page=4');
})
